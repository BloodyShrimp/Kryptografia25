...
# Treść notebooka z rozwiązanymi zadaniami
notebook_content = {
 "cells": [
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "def pow_mod(x, n, m):\n",
    "    p = 1\n",
    "    # Konwersja n na string binarny bez '0b'\n",
    "    bin_n = bin(n)[2:]\n",
    "    \n",
    "    for bit in bin_n:\n",
    "        # Krok 3: p -> p^2 mod m\n",
    "        p = (p * p) % m\n",
    "        \n",
    "        # Krok 4: jeśli bit jest jedynką, p -> p*x mod m\n",
    "        if bit == '1':\n",
    "            p = (p * x) % m\n",
    "            \n",
    "    return p"
  ...
  },
  {
   ...
   "source": [
    ...
    "    # Szukamy x, y takich, że ax + by = gcd(a, b)\n",
    ...
    "    \n",
    "    if g != 1:\n",
    "        return None # Odwrotność nie istnieje\n",
    "    else:\n",
    "        return x % n"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "        # Opcjonalne: pomijamy parzyste dla wydajności\n",
    "        if num > 2 and num % 2 == 0:\n",
    "            continue\n",
    "        if Fermat_test(num, 5):\n",
    "            return num"
   ]
  },
  {
...
# Zapisanie pliku
with open("Lista7_done.ipynb", "w", encoding='utf-8') as f:
    json.dump(notebook_content, f, indent=1)

print("Plik Lista7_done.ipynb został utworzony!")